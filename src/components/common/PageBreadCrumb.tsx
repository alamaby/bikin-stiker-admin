...
// Original: src/components/common/PageBreadCrumb.tsx — adapted for locale prefix.
...
const PageBreadcrumb: React.FC<BreadcrumbProps> = ({ pageTitle, homeHref = "/", homeLabel = "Home" }) => {
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
      ...
      <nav>
        <ol className="flex items-center gap-1.5">
          <li>
            <Link className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href={homeHref}>
              {homeLabel}
